...
%Example code for functional clustering PVH neuorons using their responses
%in fear retrieval experiment
%saintgene 2018/10/10

if(nargin ==0)
    strFn = 'Fear_Resp_Pool.mat';
    strBehav = 'Fear';
    strDir_Sav = '.\Cluster_By_Resp';
end
vtPCA_Sel = 3:6;
%%
load(strFn);
...
subplot(1,3,1);
idxOrder = resp_dendrogram_v2(Y,nNeuronCount,dColorThresh);
